...
const __vite_import_meta_env__ = { "ASSETS_PREFIX": void 0, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_CLERK_PUBLISHABLE_KEY": "pk_test_Z3JhbmQtZm9hbC0xMy5jbGVyay5hY2NvdW50cy5kZXYk", "PUBLIC_SUPABASE_ANON_KEY": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im11cXlybnZ1dW5jbWNka21sZ3F2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDg2NDc0NjYsImV4cCI6MjA2NDIyMzQ2Nn0.899kSwGTsPYS_anBdKpoBrzyxSTobEcQJkjLrwHsxiw", "PUBLIC_SUPABASE_URL": "https://muqyrnvuuncmcdkmlgqv.supabase.co", "SITE": void 0, "SSR": true };
function getContextEnvVar(envVarName, contextOrLocals) {
  ...
  return Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_Trp6sgsdmRBW24557delwrE20NGO2ySCAghrAcDXmQ", Path: process.env.Path, PUBLIC: process.env.PUBLIC })[envVarName];
}
...
var createClerkClientWithOptions = (context, options) => createClerkClient({
  ...
  sdkMetadata: {
    ...
    environment: Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_Trp6sgsdmRBW24557delwrE20NGO2ySCAghrAcDXmQ", Path: process.env.Path, PUBLIC: process.env.PUBLIC }).MODE
  },
  telemetry: {
