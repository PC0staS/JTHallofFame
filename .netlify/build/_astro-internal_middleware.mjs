...
import "kleur/colors";
import { A as AstroError, R as ResponseSentError, o as originPathnameSymbol, F as ForbiddenRewrite } from "./chunks/astro/server_-cF_Yyy_.mjs";
import "clsx";
...
const __vite_import_meta_env__ = { "ASSETS_PREFIX": void 0, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_CLERK_PUBLISHABLE_KEY": "pk_live_Y2xlcmsuam9uYXN0b3duLmVzJA", "PUBLIC_SUPABASE_ANON_KEY": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im11cXlybnZ1dW5jbWNka21sZ3F2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDg2NDc0NjYsImV4cCI6MjA2NDIyMzQ2Nn0.899kSwGTsPYS_anBdKpoBrzyxSTobEcQJkjLrwHsxiw", "PUBLIC_SUPABASE_URL": "https://muqyrnvuuncmcdkmlgqv.supabase.co", "SITE": void 0, "SSR": true };
function getContextEnvVar(envVarName, contextOrLocals) {
  ...
  return Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_live_MAMdwAQRZTMwZ0sqVy78pnHi0YmvfMLcoTJW1BkKA4", Path: process.env.Path, PUBLIC: process.env.PUBLIC })[envVarName];
}
...
var createClerkClientWithOptions = (context, options) => createClerkClient({
  ...
  userAgent: `${"@clerk/astro"}@${"2.8.2"}`,
  sdkMetadata: {
    name: "@clerk/astro",
    version: "2.8.2",
    // eslint-disable-next-line turbo/no-undeclared-env-vars
    environment: Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_live_MAMdwAQRZTMwZ0sqVy78pnHi0YmvfMLcoTJW1BkKA4", Path: process.env.Path, PUBLIC: process.env.PUBLIC }).MODE
  },
  telemetry: {
...
var createGetAuth = ({ noAuthStatusMessage }) => {
  return (req, locals, { treatPendingAsSignedOut = true, ...opts } = {}) => {
...
function decorateAstroLocal(clerkRequest, context, requestState) {
  ...
  context.locals.auth = ({ treatPendingAsSignedOut } = {}) => {
